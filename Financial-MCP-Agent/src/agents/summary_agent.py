...
from utils.logging_config import setup_logger, ERROR_ICON, SUCCESS_ICON, WAIT_ICON
...
def load_finr1_model(model_path="/home/ippl/xpg/stock_Agent/model"):
    """加载FinR1模型"""
        ...
        **重要提醒：**
        ...
        if model_choice == "local":
            ...
            model_config = {
                ...
                "temperature": 0.5,
                "max_tokens": 5000,
                "model_path": "/home/ippl/xpg/stock_Agent/model"
            }
